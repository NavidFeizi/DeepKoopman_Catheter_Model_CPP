...
public:
	...
	// function that returns the simulation time in the dynamics evolution problem
...
blaze::StaticVector<double, 6UL + numTendons> TendonDriven<N, numTendons>::residueFunction(const blaze::StaticVector<double, 6UL + numTendons> &initGuess)
{
	...
	*/
	...
	blaze::StaticVector<double, 3UL> qL, wL, qL_t, wL_t;
...
// function that increments time in the dynamics evolution problem
template <std::size_t N, std::size_t numTendons>
double TendonDriven<N, numTendons>::getSimulationTime()
{
	// time step code goes in here
